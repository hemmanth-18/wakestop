...
export const BusIcon = ({ size = 24, className = "", ...props }) => (
  ...
  >
    ...
    <path d="M16 6v6" />
    <path d="M4 12h16" />
    <rect width="18" height="13" x="3" y="5" rx="3" />
    <path d="M7 18.01v.01" />
    <path d="M17 18.01v.01" />
...
export const Volume2Icon = ({ size = 24, className = "", ...props }) => (
  <svg
    ...
    {...props}
  >
    <path d="M11 4.702a.5.5 0 0 0-.812-.39L6.108 7.5H3.5A1.5 1.5 0 0 0 2 9v6a1.5 1.5 0 0 0 1.5 1.5h2.608l4.08 3.188a.5.5 0 0 0 .812-.39z" />
...
export const CpuIcon = ({ size = 24, className = "", ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const MoonIcon = ({ size = 24, className = "", ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const SunIcon = ({ size = 24, className = "", ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const TrendingUpIcon = ({ size = 24, className = "", ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const EyeOffIcon = ({ size = 24, className = "", ...props }) => (
  ...
  >
    ...
    <path d="M17.479 17.499A10.75 10.75 0 0 1 2.062 12.348a1 1 0 0 1 0-.696 10.75 10.75 0 0 1 4.167-4.631" />
    <line x1="2" x2="22" y1="2" y2="22" />
  </svg>
);

export const CameraIcon = ({ size = 24, className = "", ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const AlertIcon = ({ size = 24, className = "", ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const LogOutIcon = ({ size = 24, className = "", ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const MailIcon = ({ size = 24, className = "", ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
